  ...
  return (
    ...
    >
      ...
      <SpreadsheetMenuBar
        ...
        handleNewSpreadsheet={handleNewSpreadsheet}
      ...
      <SpreadsheetGrid
        ...
        handleCellChange={setCellEditValue}
...
export default GoogleSheetsClone;
        ...
        <div className="bg-gray-100 border-t border-gray-200 px-4 sm:px-6 py-3 w-full z-50 fixed bottom-0 right-0 shadow-lg">
